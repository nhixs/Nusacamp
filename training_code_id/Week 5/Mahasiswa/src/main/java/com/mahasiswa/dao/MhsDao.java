...
public class MhsDao {
	...
	public int update(Mhs p){  
	    String sql="update nwstudent set Name='"+p.getName()+"', Email="+p.getEmail()+",Course='"+p.getCourse()+"' where Student_ID="+p.getStudent_ID()+"";  
	    return template.update(sql);  
	}  
	public int delete(int id){  
	    String sql="delete from nwstudent where Student_ID="+id+"";  
	    return template.update(sql);  
	}  
